...
### Agent Tools / เครื่องมือ Agent (46+ เครื่องมือ)
...
│   ├── AgentToolService     # 46+ tools, native schemas, hooks integration
...
│   └── ...                  # Buddy, Localization, Activation, GPU, HuggingFace, etc.
...
├── App.xaml.cs           # DI container (28 services, 8 ViewModels)
