...
public class HuggingFaceService
{
    ...
    private static readonly List<RecommendedModel> CuratedCodingModels = new()
    {
        ...
        // ★ Gemma 3 — Google's latest open model (March 2025)
